...
"<style>body { background-color: #1FB61A}</style></head>\r\n"
"<center><h1>405410018's picture</h1><br>\r\n"
"<body><center><h1><marquee behavior=alternate scrollamount=20 bgcolor=#1FBB1A> ~~~   ~~~   ~~~   ~~~   ~~~   ~~~   ~~~~~~   ~~~   ~~~   ~~~   ~~~   ~~~   ~~~~~~   ~~~   ~~~   ~~~   ~~~   ~~~   ~~~~~~   ~~~   ~~~   ~~~   ~~~   ~~~   ~~~~~~   ~~~   ~~~   ~~~   ~~~   ~~~   ~~~~~~   ~~~   ~~~   ~~~   ~~~   ~~~   ~~~</marquee></h1><br>\r\n"
"<a href=https://i.screenshot.net/z59npu8><img src=https://i.screenshot.net/z59npu8></center></body></html>\r\n"
"<center><h2> -->location<-- </h2><br></body></html>\r\n";
				...
				if (FD_ISSET(i, &read_fds)) {
					if (i == sock_fd) {
						...
						if (new_fd == -1) {
							...
							if(!strncmp(buff, "GET /JoelEmbiid.jpg", 19))
							{
								fdimg = open("JoelEmbiid.jpg", O_RDONLY);
